...
import type { MenuModalProps } from './MenuModal.types';
import { MenuModalController } from './MenuModal.controller';
import { View, type ViewStyle } from 'react-native';

export function MenuModal<Scrollable extends boolean | undefined = undefined>({
  onPress,
  onLongPress,
  disableNativeModal,
  disablePortal,
  ...
  activateOn = 'press',
  ...props
}: MenuModalProps<Scrollable>) {
  const controller = MenuModalController({ onPress, onLongPress });
